<#
	.SYNOPSIS
		Installs the WinEventLogCustomization Module from github
		
	.DESCRIPTION
		This script installs the WinEventLogCustomization Module from github.
